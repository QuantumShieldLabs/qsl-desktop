...
## Scope
This repository contains the in-development desktop client for the QSL protocol project (see README.md). It is pre-release and currently contains no runnable application. Report any issue that impacts the confidentiality, integrity, or availability of the artifacts in this repository.
